...
var (
	outputFile = flag.String("output", "stock_data.csv", "Output CSV file path")
	numRows    = flag.Int("rows", 1000000, "Number of rows to generate")
)
